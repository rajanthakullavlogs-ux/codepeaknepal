        ...
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-24">
          ...
          <div className="w-full lg:flex-[1.15] text-center lg:text-left">
            <ScrollReveal delay={0.1}>
              <h1 className="text-5xl md:text-6xl lg:text-[70px] font-extrabold text-[#111111] dark:text-white mb-6 tracking-tight leading-tight">
                Scalable Websites, <br className="hidden lg:block"/> <span className="text-[#2D45FF] dark:text-blue-400">Mobile Apps</span> & <br className="hidden lg:block"/> Custom Software
              </h1>
            </ScrollReveal>
