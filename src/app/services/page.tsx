      ...
      <section className="pt-28 pb-16 relative z-10">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <motion.div
            ...
            className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white border border-gray-200 text-gray-600 font-semibold text-sm uppercase tracking-widest mb-8 shadow-sm"
          >
            Our Services
          </motion.div>
          <motion.h1 
            ...
            className="text-4xl md:text-6xl font-extrabold text-navy mb-8 leading-tight tracking-tight"
          >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {services.map((service, idx) => (
              <motion.div 
                ...
                className="group relative bg-white rounded-[2rem] p-10 shadow-sm border border-gray-100 hover:shadow-2xl hover:shadow-primary/5 hover:-translate-y-2 transition-all duration-500 flex flex-col h-full overflow-hidden"
              >
                ...
                <div className="flex justify-between items-start mb-8">
                  ...
                  <div className="w-10 h-10 rounded-full bg-gray-50 flex items-center justify-center text-gray-400 group-hover:bg-primary group-hover:text-white transition-colors duration-500">
                    <ArrowUpRight className="w-5 h-5 group-hover:rotate-45 transition-transform duration-500" />
                  </div>
                </div>

                {/* Content */}
                <h3 className="text-2xl font-bold text-navy tracking-tight mb-4 group-hover:text-primary transition-colors duration-300">
                  {service.title}
                </h3>
