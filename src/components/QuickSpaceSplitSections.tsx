          ...
          <div className="flex flex-col lg:flex-row items-center gap-16">
            ...
            <div className="flex-1">
              <motion.h2 
                ...
                viewport={{ once: true }}
                className="text-3xl md:text-4xl font-bold text-navy mb-6 leading-tight max-w-lg"
              >
              ...
              <motion.p 
                ...
                className="text-gray-500 mb-10 max-w-lg leading-relaxed text-lg"
              >
            ...
            <div className="flex-1 w-full relative flex justify-center">
              <motion.div
                ...
                className="relative w-full max-w-md aspect-square bg-gray-50 rounded-2xl border border-gray-200 shadow-xl overflow-hidden"
              >
          ...
          <div className="flex flex-col lg:flex-row-reverse items-center gap-16">
            ...
            <div className="flex-1 w-full relative flex justify-center">
              <motion.div
                ...
                viewport={{ once: true }}
                transition={{ duration: 0.7 }}
                className="relative w-full max-w-md aspect-square bg-gray-50 rounded-3xl border border-gray-200 shadow-xl flex items-center justify-center p-8 overflow-hidden group"
              >
                {/* Abstract Cloud/Mobile/Data Architecture Visual */}
