    ...
    <section className="py-16 relative z-10">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <motion.div 
          ...
          viewport={{ once: true }}
          className="bg-navy rounded-[2.5rem] px-8 py-8 md:px-12 md:py-8 relative overflow-hidden shadow-2xl border border-gray-800"
        >
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 mb-6 pb-6 border-b border-gray-800/60">
              <div>
                <motion.div
                  ...
                  whileInView={{ opacity: 1, y: 0 }}
                  viewport={{ once: true }}
                  className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/10 border border-white/10 text-gray-300 font-semibold text-xs uppercase tracking-widest mb-4"
                >
                  By The Numbers
                </motion.div>
                <motion.h2 
              ...
              <motion.p 
                ...
                className="text-sm md:text-base text-gray-400 max-w-sm md:text-right font-medium"
              >
